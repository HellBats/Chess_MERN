...
export default function Move({ row, column,position,setMove,setPosition,color,king_move,setKing_move,rook_move,setRook_move}) {  
    ...
    setMove(prevMove=> {
      ...
      let my_turn = (piece_color && color) || (!piece_color && !color);
      console.log(piece_color,my_turn);
      if(cords.length==1)
        {
          if(!my_turn){return [];}
  ...
  function MovetoPiece({cords,position,setPosition,color,king_move,setKing_move})
  {
